package app.himawari.allcommon;
...
import app.himawari.allcommon.DBFluteInitializer;
 ...
 */
@Configuration
@ComponentScan(value="app.himawari.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new app.himawari.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new app.himawari.allcommon.ImplementedInvokerAssistant();
    }
