...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Member> selectByUniqueOf(String memberAccountId) {
        return facadeSelectByUniqueOf(memberAccountId);
    }

    protected OptionalEntity<Member> facadeSelectByUniqueOf(String memberAccountId) {
        return doSelectByUniqueOf(memberAccountId, typeOfSelectedEntity());
    }

    protected <ENTITY extends Member> OptionalEntity<ENTITY> doSelectByUniqueOf(String memberAccountId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberAccountId), tp), memberAccountId);
    }

    protected MemberCB xprepareCBAsUniqueOf(String memberAccountId) {
        assertObjectNotNull("memberAccountId", memberAccountId);
        return newConditionBean().acceptUniqueOf(memberAccountId);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadMemberRole</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">roleCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<MemberRole> loadMemberRole(List<Member> memberList, ReferrerConditionSetupper<MemberRoleCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadMemberRole(memberList, new LoadReferrerOption<MemberRoleCB, MemberRole>().xinit(refCBLambda));
    }
     ...
     * MEMBER_ROLE by MEMBER_ID, named 'memberRoleList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadMemberRole</span>(<span style="color: #553000">member</span>, <span style="color: #553000">roleCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">roleCB</span>.setupSelect...
     *     <span style="color: #553000">roleCB</span>.query().set...
     *     <span style="color: #553000">roleCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getMemberRoleList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberRole> loadMemberRole(Member member, ReferrerConditionSetupper<MemberRoleCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadMemberRole(xnewLRLs(member), new LoadReferrerOption<MemberRoleCB, MemberRole>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<MemberRole> doLoadMemberRole(List<Member> memberList, LoadReferrerOption<MemberRoleCB, MemberRole> option) {
        return helpLoadReferrerInternally(memberList, option, "memberRoleList");
    }
    ...
    /**
     * Extract the value list of (single) unique key memberAccountId.
     * @param memberList The list of member. (NotNull, EmptyAllowed)
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<String> extractMemberAccountIdList(List<Member> memberList)
    { return helpExtractListInternally(memberList, "memberAccountId"); }
