...
public abstract class AbstractBsTimecardCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTimecardCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * TIMECARD_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setTimecardId_IsNull() { regTimecardId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * TIMECARD_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setTimecardId_IsNotNull() { regTimecardId(CK_ISNN, DOBJ); }
    ...
    public void setTimecardYearMonth_Equal(String timecardYearMonth) {
        doSetTimecardYearMonth_Equal(fRES(timecardYearMonth));
    }

    protected void doSetTimecardYearMonth_Equal(String timecardYearMonth) {
        regTimecardYearMonth(CK_EQ, timecardYearMonth);
    }
    ...
    public void setTimecardYearMonth_NotEqual(String timecardYearMonth) {
        doSetTimecardYearMonth_NotEqual(fRES(timecardYearMonth));
    }

    protected void doSetTimecardYearMonth_NotEqual(String timecardYearMonth) {
        regTimecardYearMonth(CK_NES, timecardYearMonth);
    }
    ...
    public void setTimecardYearMonth_GreaterThan(String timecardYearMonth) {
        regTimecardYearMonth(CK_GT, fRES(timecardYearMonth));
    }
    ...
    public void setTimecardYearMonth_LessThan(String timecardYearMonth) {
        regTimecardYearMonth(CK_LT, fRES(timecardYearMonth));
    }
    ...
    public void setTimecardYearMonth_GreaterEqual(String timecardYearMonth) {
        regTimecardYearMonth(CK_GE, fRES(timecardYearMonth));
    }
    ...
    public void setTimecardYearMonth_LessEqual(String timecardYearMonth) {
        regTimecardYearMonth(CK_LE, fRES(timecardYearMonth));
    }
    ...
    public void setTimecardYearMonth_InScope(Collection<String> timecardYearMonthList) {
        doSetTimecardYearMonth_InScope(timecardYearMonthList);
    }

    protected void doSetTimecardYearMonth_InScope(Collection<String> timecardYearMonthList) {
        regINS(CK_INS, cTL(timecardYearMonthList), xgetCValueTimecardYearMonth(), "TIMECARD_YEAR_MONTH");
    }
    ...
    public void setTimecardYearMonth_NotInScope(Collection<String> timecardYearMonthList) {
        doSetTimecardYearMonth_NotInScope(timecardYearMonthList);
    }

    protected void doSetTimecardYearMonth_NotInScope(Collection<String> timecardYearMonthList) {
        regINS(CK_NINS, cTL(timecardYearMonthList), xgetCValueTimecardYearMonth(), "TIMECARD_YEAR_MONTH");
    }
     ...
     */
    public void setTimecardYearMonth_LikeSearch(String timecardYearMonth, ConditionOptionCall<LikeSearchOption> opLambda) {
        setTimecardYearMonth_LikeSearch(timecardYearMonth, xcLSOP(opLambda));
    }
     ...
     */
    protected void setTimecardYearMonth_LikeSearch(String timecardYearMonth, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(timecardYearMonth), xgetCValueTimecardYearMonth(), "TIMECARD_YEAR_MONTH", likeSearchOption);
    }
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setTimecardYearMonth_NotLikeSearch(String timecardYearMonth, ConditionOptionCall<LikeSearchOption> opLambda) {
        setTimecardYearMonth_NotLikeSearch(timecardYearMonth, xcLSOP(opLambda));
    }
     ...
     */
    protected void setTimecardYearMonth_NotLikeSearch(String timecardYearMonth, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(timecardYearMonth), xgetCValueTimecardYearMonth(), "TIMECARD_YEAR_MONTH", likeSearchOption);
    }

    protected void regTimecardYearMonth(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueTimecardYearMonth(), "TIMECARD_YEAR_MONTH"); }
    protected abstract ConditionValue xgetCValueTimecardYearMonth();
     ...
     */
    public HpSLCFunction<TimecardCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TimecardCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TimecardCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TimecardCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TimecardCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TimecardCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TimecardCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TimecardCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TimecardCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TimecardCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TimecardCB&gt;() {
     *     public void query(TimecardCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TimecardCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TimecardCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TimecardCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TimecardCQ sq);

    protected TimecardCB xcreateScalarConditionCB() {
        TimecardCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TimecardCB xcreateScalarConditionPartitionByCB() {
        TimecardCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TimecardCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TimecardCB cb = new TimecardCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "TIMECARD_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TimecardCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TimecardCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TimecardCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TimecardCB cb = new TimecardCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "TIMECARD_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TimecardCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TimecardCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TimecardCB cb = new TimecardCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TimecardCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TimecardCB newMyCB() {
        return new TimecardCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TimecardCQ.class.getName(); }
